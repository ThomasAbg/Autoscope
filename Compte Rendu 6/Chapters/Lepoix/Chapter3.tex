...
\section{Support du bus I2C} %TODO Communication avec IMU
...
La trame d'écriture à l'adresse \codeinline{text}{0x5A} est émise mais n'est acquittée par aucun périphérique, ce qui est normal. La seconde trame, la donnée à écrire \codeinline{text}{0x00} n'est donc pas émise.

%TODO meilleurs tests i2c
